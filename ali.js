...
console.log('log 0 : this message is written by me and dissplayed in the console');
var x, y, z;
x = 3;
y = 9;
z = x + y;
...
var func = myfunc(x, y);
var object_person =
{      //this is an object containig all the shit niggas
    firstname: 'ali',
...
console.log('log 1 : the position of the first string in the variable string using indexOf() is ' + string.indexOf('string'));
var position_last = string.lastIndexOf('string');
console.log('log 2 : the position of the last string in the variable string using lastIndexOf() is ' + string.lastIndexOf('string'));
var search_pos = string.search('to use the');
console.log('log 3 : the position of the first string in the variable string using search() is ' + string.search('string'));
var string_sliced = string.slice(8, 12);
console.log('log 4 : this word was sliced out of the string using .slice()' + string.slice(8, 12));
var string2 = "Kiwi , banana , Pride , ME , javascript";
var replaced = string2.replace('banana', 'milkchoclate');
console.log('log 5 : this is another string which banana has been replaced with milkchoclate in using .replace()' + string2.replace('banana', 'milkchoclate'));
var toupper = string2.toUpperCase();
console.log('log 6 : string converted to all upper case using .toUpperCase() ' + string2.toUpperCase());
var tolowwer = string2.toLowerCase();
console.log('log 7 : string converted to all lower case using .toLowerCase() ' + string2.toLowerCase());
var trimed = string2.trim(); //it removes spaces from both  start and end of the
string.charAt(20); // returns the character at that position // you can also use charCodeAt(index)
string[0]; //returns the first character of the string
var str_arr = string2.split(",");//splits the string into array by the commas
console.log("log 8 : " + string2);
...
console.log("log 9 : number 9.4291 with exponential 3 is " + math_number.toExponential(3)); // returns a string
console.log("log 10 : number 9.4291 with fixed 3 is " + math_number.toFixed(3)); // returns a string
console.log("log 11 : number 9.4291 with fixed 3 is " + math_number.toPrecision(3)); // returns a string
console.log("log 12 : the function number() can turn its content string or whatever into number '  10.33    'is" + Number('  10.33    '));
console.log("log 13 : Number(true) is " + Number(true));
console.log("log 14 : Number('john') is " + Number("john"));
console.log("log 15 : Number(new Date('2018-08-08')) is " + Number(new Date("2018-08-08")));
console.log("log 16 : parseInt('10 20 30') is " + parseInt('10 20 30'));
console.log("log 17 : parseInt('10.33') is " + parseInt('10.33'));
console.log("log 18 : parseInt('10 years') is " + parseInt('10 years'));
console.log("log 19 : parseInt('years 10') is " + parseInt('years 10'));
console.log("log 20 : parseFloat('10 20 30') is " + parseFloat('10 20 30'));
console.log("log 21 : parseFloat('10.33') is " + parseFloat('10.33'));
console.log("log 22 : parseFloat('10 years') is " + parseFloat('10 years'));
console.log("log 23 : parseFloat('years 10') is " + parseFloat('years 10'));
...
console.log('log 24 : the sorted array using .sort() is ' + fruitArr);
fruitArr.push('dragonFruit');
console.log('log 25 : the fruit array after being pushed \n' + fruitArr);
console.log('log 26 : the array converted to a string \n' + fruitArr.toString());
console.log('log 27 : the array converted to a string with join("*") \n' + fruitArr.join("*"));
fruitArr.pop();
console.log('log 28 :the fruit array after being poped is ' + fruitArr);
fruitArr.shift(); //removes the first element //returns a string
console.log('log 29 : array after being shifted is ' + fruitArr);
fruitArr.unshift('grape'); //adds an element to the start of an array // returns the new array length
console.log('log 30 : array after being unshift("grape") is \n' + fruitArr);
